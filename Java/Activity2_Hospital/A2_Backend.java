...
public class A2_Backend {
    ...
    public void add_to_masterlist(String fname, String lname, String admission_date, String disease, String discharge_date, String spc, int age, String str_age) 
    {
        String concat_patient = fname + spc + lname + spc + admission_date + spc + disease + spc + discharge_date + spc + str_age;
        try {
